...
export function AdminNavbar({
    ...
    return (
        <header className="admin-surface sticky top-0 z-40 flex min-w-0 flex-col gap-3 border-b border-[#040DBF]/10 bg-white/70 px-4 py-4 shadow-sm backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between sm:px-6">
