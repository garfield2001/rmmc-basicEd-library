...
import type { StudentAssignmentPreview } from '@/types/registered-visitors';
...
export function BulkStudentAssignmentPanel({ open, onOpenChange, onAssigned }: BulkStudentAssignmentPanelProps) {
    ...
    const previewStudents: FormEventHandler = async (event) => {
        ...
        try {
            const response = await csrfFetch('/admin/registered-visitors/preview-student-assignment', {
                method: 'POST',
                headers: {
