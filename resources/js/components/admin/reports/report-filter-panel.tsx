...
export function ReportFilterPanel({
    ...
    const schoolYearDateLabel = 'Whole school year';
    ...
    return (
        <section className="admin-surface space-y-3.5 rounded-xl border border-[#040DBF]/10 bg-white/95 p-4 shadow-sm sm:p-5 dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-[#040DBF]/10 bg-[#f6f8ff] px-3.5 py-2 text-xs text-[#020659] dark:border-slate-800 dark:bg-slate-800/60 dark:text-slate-300">
                <div className="flex flex-wrap items-center gap-2">
                    <span className="font-semibold text-[#010440] dark:text-white">Period:</span>
                    <span className="font-medium">{dateRangeSummary}</span>
                ...
                {onResetFilters && (
                    <button
                        ...
                        className="inline-flex items-center gap-1 font-semibold text-[#040DBF] hover:underline dark:text-sky-400"
                    >
