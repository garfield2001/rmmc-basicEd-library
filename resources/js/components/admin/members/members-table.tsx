...
export function MembersTable({
    ...
    const displayedMemberIds = displayedMembers.map((member) => member.id);
    ...
    }, [activeType, copyFilters.search, copyFilters.year_level, copyFilters.section]);
    ...
    const copySelectedColumns = async () => {
        ...
        try {
            const response = await csrfFetch('/admin/members/copy-columns', {
                method: 'POST',
                headers: {
                    ...
                    {selectedCount > 0 && (
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            <button
                                ...
                                className="inline-flex h-9 items-center gap-2 rounded-lg border border-red-200 bg-white px-3 text-sm font-medium text-red-600 transition-[background-color,border-color,color,box-shadow] hover:border-red-300 hover:bg-red-50 hover:text-red-700 hover:shadow-sm"
                            >
        ...
        <TableRow>
            ...
            <TableCell>
                <div className="flex justify-end gap-2">
                    <ActionButton label="Edit member" icon={Pencil} onClick={onEdit} />
                    <ActionButton label="Delete member" icon={Trash2} onClick={onDelete} />
                </div>
            </TableCell>
        </TableRow>
    );
