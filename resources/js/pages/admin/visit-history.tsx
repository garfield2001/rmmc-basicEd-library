            ...
            <main className="min-h-screen">
                <AdminLayout active="visit-history">
                    <div className="admin-content-shell mx-auto w-full space-y-6 px-4 py-6 sm:px-6 lg:py-8">
                        <AdminPageHeader
                            ...
                            badge={
                                <div className="flex items-center gap-2">
                                    <span
                                        className={`visit-history-audience-badge ${audienceClass} rounded-full border px-3 py-1 text-sm font-semibold shadow-sm`}
                                    >
                        ...
                        <div className="admin-surface relative mt-6 flex flex-col overflow-hidden rounded-lg border border-[#040DBF]/10 bg-white/95 pt-2 shadow-sm lg:flex-row">
                            <div className="absolute top-0 right-0 left-0 z-10 h-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-800" />
                            <div className="order-2 flex w-full flex-col border-t border-[#040DBF]/10 lg:order-1 lg:w-2/3 lg:border-t-0 lg:border-r xl:w-3/4">
                            ...
                            <div className="order-1 flex h-[400px] w-full shrink-0 flex-col bg-white lg:order-2 lg:h-auto lg:w-1/3 xl:w-1/4">
